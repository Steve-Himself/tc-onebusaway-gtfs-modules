 ...
 * {@link #StopIdFieldMappingFactory(String)} constructor, we will
...
public class StopIdFieldMappingFactory implements FieldMappingFactory {
  ...
  public StopIdFieldMappingFactory() {
    this(null);
  }

  public StopIdFieldMappingFactory(String agencyIdPath) {
  ...
  private class FieldMappingImpl extends DefaultFieldMapping {
    ...
    private String resolveAgencyId(CsvEntityContext context, BeanWrapper object) {
      ...
      if (_agencyIdPath == null) {
        ...
        return ctx.getDefaultStopAgencyId();
      }
